...
exports.activeTicketId = exports.listWorkspaceTicketsWithTotal = exports.listWorkspaceTickets = void 0;
const child_process_1 = require("child_process");
function runCli(args) {
    return new Promise((resolve) => {
        (0, child_process_1.execFile)('deuk-agent-flow', args, { encoding: 'utf8', shell: true }, (err, stdout) => {
 ...
 */
async function listWorkspaceTickets(workspaceName, opts = {}) {
    const { tickets } = await listWorkspaceTicketsWithTotal(workspaceName, opts);
    return tickets;
}
exports.listWorkspaceTickets = listWorkspaceTickets;
/**
 ...
 */
async function listWorkspaceTicketsWithTotal(workspaceName, opts = {}) {
    ...
    try {
        ...
        if (Array.isArray(parsed))
            return { tickets: parsed, total: parsed.length };
...
exports.listWorkspaceTicketsWithTotal = listWorkspaceTicketsWithTotal;
/** 워크스페이스의 활성(claim) 티켓 id 를 CLI status 에서 받는다. 없으면 null. */
async function activeTicketId(workspaceName) {
...
exports.activeTicketId = activeTicketId;
//# sourceMappingURL=ticketHome.js.map